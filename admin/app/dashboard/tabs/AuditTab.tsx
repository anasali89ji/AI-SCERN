...
export default function AuditTab() {
  ...
  const { data, isLoading, error, mutate } = useSWR<{ entries: AuditEntry[]; total: number; pages: number }>(`/audit-log?page=${page}${actionFilter ? `&action=${actionFilter}` : ''}`, (p: string) => api(p))
