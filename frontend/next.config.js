    ...
    { source: '/:path*', headers: [
      ...
      { key: 'Cross-Origin-Opener-Policy', value: 'same-origin-allow-popups'        },
      {
        ...
        value: [
          ...
          "img-src 'self' data: blob: https: https://img.clerk.com https://*.supabase.co https://images.unsplash.com https://*.clerk.accounts.dev https://*.aiscern.com https://*.r2.cloudflarestorage.com https://*.r2.dev https://api.producthunt.com",
