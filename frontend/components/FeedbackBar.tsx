    ...
    <div className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-[#0f0f17] border border-white/[0.08]">
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-rose-500/10 border border-rose-500/20 text-rose-400 text-xs font-semibold hover:bg-rose-500/20 transition-all"
        >
