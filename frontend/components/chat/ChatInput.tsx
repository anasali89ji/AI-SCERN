      ...
      <div className="max-w-3xl mx-auto flex items-end gap-2">
        <div className="flex-1 relative">
          <textarea
            ...
            className="w-full resize-none max-h-32 rounded-xl bg-slate-900 border border-white/[0.08] text-white placeholder:text-slate-600 px-4 py-3 pr-12 text-[16px] sm:text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500/30 transition-all disabled:opacity-50"
