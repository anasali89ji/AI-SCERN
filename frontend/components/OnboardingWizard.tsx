...
const MODALITY_OPTIONS = [
  { id:'text',  icon: FileType2, label:'Text',   sub:'Verify AI-written articles & essays' },
        ...
        >
          ...
          {step === 'modalities' && (
            <div className="space-y-5">
              <div className="text-center">
                <h2 className="text-xl font-black text-white">What will you verify?</h2>
          ...
          {step === 'ready' && (
            <div className="text-center space-y-5">
              ...
              <p className="text-[#64748b] text-sm leading-relaxed">
                Your account is ready. Start with a free examination — no upload required for text verification.
              </p>
