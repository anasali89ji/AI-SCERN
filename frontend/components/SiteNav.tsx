...
const TOOLS = [
  ...
  { href: '/chat',         label: 'ARIA Assistant', icon: MessageSquare, desc: 'Verification chat'       },
  { href: '/batch',        label: 'Bulk Verification', icon: Database,      desc: 'Bulk content examination'   },
]
          ...
          {user ? (
            ...
            <>
              ...
              >
                ...
                <span className="hidden sm:inline">Begin Verification</span>
              ...
              >
                ...
                <Link
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-3 min-h-[48px] rounded-lg
                             ...
                             focus-visible:ring-2 focus-visible:ring-accent/50"
                >
                  <Zap className="w-4 h-4" aria-hidden="true" /> Begin Verification Free
                </Link>
              </motion.div>
            )}
          </motion.div>
