...
const FALLBACK: Review[] = [
  { id:'f1', body:"Had a batch of essays that felt off but I couldn't say why. Ran them through this and the heatmap literally pointed at the paragraphs that were rewritten. Kind of wild honestly.", display_name:'Dr. Sarah M.', tool_used:'Text Verification' },
  { id:'f2', body:"We almost ran a photo that turned out to be manipulated. Caught it 10 minutes before publish. That's the only reason I still use this thing.", display_name:'James K.', tool_used:'Image Verification' },
  { id:'f3', body:"idk if it's perfect but it's caught 2 voice clones for me this year so I'm not complaining. Takes like 20 seconds per clip.", display_name:'Priya L.', tool_used:'Audio Verification' },
  { id:'f4', body:'Started using this for resume screening after one too many suspiciously perfect cover letters. Not foolproof but it flags enough that it saves me time.', display_name:'Marcus T.', tool_used:'Text Verification' },
  ...
  { id:'f6', body:"A clip was going around our group chat that looked fake to me but nobody believed it. Ran it here, frame breakdown showed exactly where it was spliced. Good enough receipts to shut that down.", display_name:'Elena R.', tool_used:'Video Verification' },
]
