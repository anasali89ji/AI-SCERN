...
const WHO_NEEDS = [
  ...
  },
  {
    role: 'Security Teams',
    icon: ShieldCheck,
    value: 'Verify deepfake video calls and synthetic identities in incident response.',
    stat: '~88%',
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-silver-600 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
            Nine professional verticals. One verification platform.
          </p>
        </div>
