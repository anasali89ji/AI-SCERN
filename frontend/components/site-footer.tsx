          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="mt-5 flex gap-3">
              <a href="https://twitter.com/aiscern" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-xl border border-border/60 bg-surface/40 flex items-center justify-center text-text-muted hover:text-purple-400 hover:border-primary/30 hover:bg-primary/8 transition-[color,border-color,background-color] duration-200"
