          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="mt-5 flex gap-3">
              <a href="https://twitter.com/aiscern" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-xl border border-border/60 bg-surface/40 flex items-center justify-center text-text-muted hover:text-blue-400 hover:border-blue-500/25 hover:bg-blue-500/8 transition-[color,border-color,background-color] duration-200"
              ...
              {subState === 'sent' ? (
                ...
                <form onSubmit={handleSub} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 min-w-0 bg-background border border-border rounded-lg px-3 py-2 text-xs text-text-primary placeholder:text-text-muted focus:outline-none focus:border-blue-500/40 transition-colors"
                  />
                  <button type="submit"
