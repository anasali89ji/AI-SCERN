  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-1">
        ...
        <textarea rows={3} placeholder="Describe your verification needs, expected volume, and any integration requirements..." className={`${INPUT_CLASS} resize-none`} value={useCase} onChange={e => setUseCase(e.target.value)} />
      </div>
