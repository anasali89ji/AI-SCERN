    ...
    <AuthGuard>
      <div className="flex h-[100dvh] bg-background overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          <header className="h-14 sm:h-16 border-b border-border/40 flex items-center justify-between px-3 sm:px-4 lg:px-6 bg-surface flex-shrink-0 sticky top-0 z-30">
