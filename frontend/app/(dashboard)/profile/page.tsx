...
function Avatar({ name, size = 96 }: { name: string; size?: number }) {
  ...
  return (
    <div
      style={{ background: 'linear-gradient(135deg,#147A18,#2BEE34)', width: size, height: size, fontSize: size * 0.32 }}
          ...
          <div className="flex items-center justify-between p-3 rounded-xl border"
            ...
            {!data.is_paid && (
              <a href="/pricing"
                ...
                style={{ background: 'linear-gradient(135deg,#147A18,#2BEE34)' }}>
                Upgrade
              </a>
            )}
          </div>
              ...
              {editing ? (
                <>
                  ...
                  <button onClick={() => setEditing(false)}
                    className="flex items-center gap-1.5 px-4 py-2 rounded-xl border border-white/[0.08] text-sm text-[#6B6B6B] hover:bg-[#141414] transition-all">
                    <X className="w-4 h-4" /> Cancel
                  </button>
                </>
              ) : (
                <button onClick={() => setEditing(true)}
                  className="flex items-center gap-1.5 px-4 py-2 rounded-xl border border-white/[0.08] text-sm font-semibold text-[#A3A3A3] hover:bg-[#141414] hover:border-[#2BEE34]/40 transition-all">
              ...
              <div className="space-y-3 max-w-sm">
                <div className="space-y-1">
                  ...
                  <input value={displayName} onChange={e => setDisplayName(e.target.value)}
                    className="w-full bg-[#141414] border border-white/[0.08] rounded-xl px-3 py-2 text-[16px] sm:text-sm text-white focus:outline-none focus:border-[#2BEE34]/50"
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input value={username} onChange={e => checkUsername(e.target.value)}
                      className="w-full bg-[#141414] border border-white/[0.08] rounded-xl pl-7 pr-9 py-2 text-[16px] sm:text-sm text-white focus:outline-none focus:border-[#2BEE34]/50"
                ...
                <div className="space-y-1">
                  ...
                  <textarea value={bio} onChange={e => setBio(e.target.value)} rows={2}
                    className="w-full bg-[#141414] border border-white/[0.08] rounded-xl px-3 py-2 text-[16px] sm:text-sm text-white focus:outline-none focus:border-[#2BEE34]/50 resize-none"
