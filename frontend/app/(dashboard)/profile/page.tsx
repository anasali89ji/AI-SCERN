...
function Avatar({ name, photoURL, avatarUrl, size = 96 }: { name: string; photoURL?: string|null; avatarUrl?: string|null; size?: number }) {
  ...
  return (
    <div
      style={{ background:'linear-gradient(135deg,#2563eb,#0891b2)', width:size, height:size, fontSize:size*0.32 }}
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto space-y-6">
      ...
      <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }}
        ...
        {/* Banner */}
        <div className="h-28 sm:h-32 relative overflow-hidden" style={{ background:'linear-gradient(135deg, rgba(37,99,235,0.3), rgba(8,145,178,0.2), rgba(37,99,235,0.15))' }}>
