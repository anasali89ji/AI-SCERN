...
function AudioDetectionPage() {
  ...
  return (
        ...
        <div className="space-y-4">
          {!file ? (
            ...
            <div className="card space-y-4">
              ...
              title="Verify Another" className="text-silver-600 hover:text-error p-2 rounded-lg hover:bg-error/10 transition-colors shrink-0">
                    <X className="w-4 h-4" />
                  </button>
                </div>
              </div>
    ...
    <div className="px-4 sm:px-6 lg:px-8 2xl:px-10 max-w-6xl 2xl:max-w-[1400px] 3xl:max-w-[1700px] mx-auto pb-6">
      ...
      <LazyReviewSuggestion toolName="Audio Verification" />
      {result && (
