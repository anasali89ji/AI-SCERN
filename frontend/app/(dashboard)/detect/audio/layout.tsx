...
export const metadata: Metadata = {
  title: 'Free AI Voice & Audio Detector — Verify ElevenLabs & Voice Cloning',
  description: 'Verify AI-synthesised voice, ElevenLabs audio, voice cloning and deepfake speech. 92%+ accuracy. Upload MP3, WAV or M4A — free, instant verification. No credit card required.',
  keywords: [
    ...
    'verify fake voice','ai speech detector','audio authenticity checker',
  ...
  openGraph: {
    ...
    description: 'Upload audio and verify if it is AI-synthesised or voice-cloned. Verifies ElevenLabs, Suno, Udio. 92%+ accuracy. Free.',
  ...
  twitter: {
    ...
    description: 'Verify AI-synthesised voice and voice cloning. 92%+ accuracy. Free.',
  },
}
  ...
  '@graph': [
    {
      ...
      'description': 'Verify ElevenLabs, voice cloning and AI-synthesised audio with 92%+ accuracy.',
    ...
    },
    {
      ...
      'mainEntity': [
                  ...
                  },
                  {
                    ...
                    "acceptedAnswer": { "@type": "Answer", "text": "Aiscern supports MP3, WAV, M4A and OGG audio files for AI voice verification. Maximum file size is 50MB." }
                  }
      ]
    }
  ,
