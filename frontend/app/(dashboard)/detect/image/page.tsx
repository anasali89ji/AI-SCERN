  ...
  return (
    ...
    <div className="p-4 sm:p-4 lg:p-8 2xl:p-10 max-w-6xl 2xl:max-w-[1400px] 3xl:max-w-[1700px] mx-auto">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-slate-500 ml-14 text-sm">GAN artifacts · Diffusion fingerprints · Pixel forensics · Metadata analysis</p>
      </div>
          ...
          {!file ? (
              ...
              <div className="space-y-3">
                <label className="flex flex-col items-center gap-3 card border-2 border-dashed border-blue-500/20 bg-blue-500/5 rounded-xl py-10 cursor-pointer  transition-transform min-h-[180px] justify-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-slate-500 mt-1">JPG · PNG · WEBP · GIF · BMP · Max 10MB</p>
                  </div>
                  <input
                    type="file"
                    accept="image/*"
            ...
            <div {...getRootProps()}
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-slate-600 mt-2">JPG · PNG · WEBP · GIF · BMP · Max 10MB</p>
              </div>
            </div>
            )
          ) : (
            <div className="card space-y-4">
              <div className="relative rounded-xl overflow-hidden bg-[#141420] group">
