    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto space-y-7">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[#6B6B6B] text-sm mt-1">Purchase verification credits. Billed in PKR via XPay.</p>
        </div>
        {balance !== null && (
            ...
            return (
              ...
              >
                ...
                <ul className="space-y-2.5 mb-6 flex-1">
                  {['Text verification', 'Image verification', 'Audio verification', 'Video verification',
      ...
      <div className="flex gap-3 p-4 rounded-xl bg-[#1A1A1A] border border-[#2A2A2A] text-sm text-[#A3A3A3]">
        ...
        <div className="space-y-1">
          <p>Credits are consumed per examination. 1 credit = 1 verification on any modality.</p>
