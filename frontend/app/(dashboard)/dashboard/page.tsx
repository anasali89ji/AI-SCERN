...
const TOOLS = [
  ...
  { href: '/batch',        icon: Layers,     label: 'Batch', desc: 'Verify 20 files at once'   },
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-[#A3A3A3] mb-4 leading-relaxed">
                Pick an verification tool to run your first examination. Free — no limits on basic examinations.
              </p>
              <div className="flex flex-wrap gap-2">
                <Link href="/detect/text"
                  ...
                  <FileType2 className="w-3.5 h-3.5" /> Try Text Verification
                </Link>
                <Link href="/detect/image"
                  ...
                  <ImageIcon className="w-3.5 h-3.5" /> Try Image Verification
                </Link>
              </div>
            </div>
          </div>
      ...
      <div className="space-y-2">
        <p className="text-xs font-semibold uppercase tracking-[0.08em] text-[#6B6B6B] mb-3">Verification Tools</p>
      ...
      {totalScans > 0 && (
        <div className="p-5 rounded-xl bg-[#141414] border border-[#333333]">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-semibold text-white">Verification Balance</h2>
        ...
        {loading ? (
          ...
          <div className="p-10 rounded-xl bg-[#141414] border border-[#333333] text-center">
            ...
            <Link href="/detect/text"
              ...
              <FileType2 className="w-4 h-4" /> Try Text Verification
            </Link>
          </div>
        ) : (
          <div className="space-y-2">
