...
const TOOLS = [
  { href: '/detect/text',  icon: FileType2,   label: 'Text',  desc: 'Detect AI writing'      },
  ...
  { href: '/detect/video', icon: Video,      label: 'Video', desc: 'Deepfake video detection' },
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-6">
      ...
      <div className="animate-fade-in">
        ...
        <p className="text-[#6B6B6B] text-sm mt-1">
          {totalScans === 0
            ? 'Run your first detection below — completely free.'
            : `You've run ${totalScans.toLocaleString()} detection${totalScans !== 1 ? 's' : ''} so far.`}
        </p>
      </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-[#A3A3A3] mb-4 leading-relaxed">
                Pick a detection tool to run your first scan. Free — 10 scans per day on text and image.
              </p>
              <div className="flex flex-wrap gap-2">
                <Link href="/detect/text"
                  ...
                  <FileType2 className="w-3.5 h-3.5" /> Try AI Text Detection
                </Link>
                <Link href="/detect/image"
                  ...
                  <ImageIcon className="w-3.5 h-3.5" /> Try Deepfake Image Detection
                </Link>
              </div>
            </div>
          </div>
      ...
      <div className="space-y-2">
        <p className="text-xs font-semibold uppercase tracking-[0.08em] text-[#6B6B6B] mb-3">AI Detection Tools</p>
      ...
      {totalScans > 0 && (
        <div className="p-5 rounded-xl bg-[#141414] border border-[#333333]">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-semibold text-white">Detection Credits</h2>
      ...
      <div className="space-y-3">
        ...
        {loading ? (
          ...
          <div className="p-8 rounded-xl bg-[#141414] border border-[#333333] text-center">
            ...
            <p className="text-[#A3A3A3] text-sm font-medium mb-1">Couldn't load detection history</p>
          ...
          <div className="p-10 rounded-xl bg-[#141414] border border-[#333333] text-center">
            ...
            <Link href="/detect/text"
              ...
              <FileType2 className="w-4 h-4" /> Try AI Text Detection
            </Link>
          </div>
        ) : (
          <div className="space-y-2">
