...
const TIERS = [
  ...
  },
  {
    ...
    yearlyPrice: 8,
    label: 'Most Popular',
    description: 'For individuals who need full verification results power.',
    highlight: true,
    cta: 'Upgrade to Pro',
...
const FEATURE_ROWS = [
  ...
  { label: 'Detection history', key: 'historyDays',  format: (v: any) => typeof v === 'number' ? `${v} days` : String(v) },
...
const FAQ = [
  { q: 'Is the free tier permanent?',      a: 'Yes. We believe access to basic AI verification should not require a subscription. The free tier is permanent.' },
  { q: 'Do you store my content?',         a: "Files are processed and immediately deleted. We do not store your text or media files for analysis purposes. Verification metadata is retained per your plan's history limit." },
