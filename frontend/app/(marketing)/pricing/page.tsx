...
const TIERS = [
  ...
  },
  {
    ...
    yearlyPrice: 8,
    label: 'Most Popular',
    description: 'For individuals who need full detection results power.',
    highlight: true,
    cta: 'Upgrade to Pro',
...
const FAQ = [
  ...
  { q: 'Do you store my content?',         a: "Files are processed and immediately deleted. We do not store your text or media files for analysis purposes. Detection metadata is retained per your plan's history limit." },
