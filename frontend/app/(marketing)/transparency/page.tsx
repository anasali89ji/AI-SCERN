...
const SECTIONS = [
  {
    ...
    items: [
      ...
      'Detection results (verdict, confidence, model breakdown) are stored in your account history only if you are signed in and have not disabled history.',
  ...
  },
  {
    ...
    color: 'blue',
    items: [
      'Detection content (text, images, audio, video) is never permanently stored unless you explicitly save a report.',
      'Detection metadata (verdict, confidence score, timestamp) is retained for signed-in users to support detection history. You can delete this at any time from your settings.',
      'Account data (email, authentication) is retained until you delete your account.',
      'Anonymous detection data: no content or metadata is retained after the browser session ends.',
  ...
  },
  {
    ...
    items: [
      ...
      'We do not use submitted detection content for model training without explicit opt-in consent.',
