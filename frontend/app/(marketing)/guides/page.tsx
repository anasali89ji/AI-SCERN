...
const GUIDES = [
  {
    ...
    desc: 'A step-by-step guide to identifying AI-written content using Aiscern\'s AI text verification ensemble. Covers paste, upload, URL analysis, and interpreting confidence scores.',
    steps: ['Paste or upload your text', 'Review overall confidence score', 'Examine sentence-level heatmap', 'Export report if needed'],
    href: '/detect/text',
    cta: 'Try AI Text Verification',
  },
  {
    icon: Eye,
    color: 'blue',
    ...
    href: '/detect/image',
    cta: 'Try Deepfake Image Verification',
  },
  {
    icon: Music,
    color: 'emerald',
    ...
    href: '/detect/audio',
    cta: 'Try AI Audio & Voice Clone Verification',
  },
  {
    icon: Video,
    color: 'amber',
    ...
    href: '/detect/video',
    cta: 'Try Deepfake Video Verification',
  },
  {
    icon: Zap,
    color: 'rose',
