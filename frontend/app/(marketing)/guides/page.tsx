...
const colorMap: Record<string, { bg: string; border: string; icon: string; badge: string }> = {
  ...
  amber:   { bg: 'bg-amber-500/10',   border: 'border-amber-500/20',   icon: 'text-amber-400',   badge: 'text-amber-400 bg-amber-500/10 border-amber-500/20'   },
  rose:    { bg: 'bg-rose-500/10',    border: 'border-rose-500/20',    icon: 'text-rose-400',    badge: 'text-rose-400 bg-rose-500/10 border-rose-500/20'     },
}
