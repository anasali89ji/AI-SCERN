...
export const metadata = {
  ...
  description: 'Aiscern is a free multi-modal AI content verification platform built in Pakistan. Verify AI-generated text, images, audio, and video with ensemble-based analysis and published accuracy benchmarks.',
...
const TIMELINE = [
  { year: '2025', title: 'Aiscern founded', desc: 'Started as a solo project to make AI content verification free and transparent, built from Pakistan.' },
  ...
  { year: '2025', title: 'Free tier launched', desc: 'Opened basic verification to anyone, no account required — because access shouldn\'t depend on budget.' },
...
const VALUES = [
  {
    ...
    desc: 'We publish our accuracy benchmarks, known limitations, and verification methodology openly. You should know exactly what our scores mean before acting on them.',
  },
  {
    icon: Brain,
  ...
  },
  {
    ...
    desc: 'AI verification tools should not be locked behind subscriptions. Aiscern offers a free tier for individuals, educators, journalists, and researchers — no account required for basic verification.',
  },
  {
    icon: Globe,
...
const TEAM = [
  {
    name:     'Anas Ali',
    role:     'Founder & CEO',
    bio:      'Building Aiscern from Pakistan. Passionate about AI transparency, media literacy, and making powerful verification tools accessible to everyone — regardless of budget or geography.',
    location: 'Pakistan',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 max-w-[60ch]">
            ...
            <p className="text-lead text-silver-600">
              Free, open, and honest AI content verification. Built for educators, journalists, HR teams, and anyone who needs to know if content is human or machine-made.
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="bg-depth-bg border border-white/[0.06] rounded-xl p-6 sm:p-8">
              <p className="text-silver-600 text-base leading-relaxed mb-4">
                Aiscern exists because AI-generated content is now indistinguishable from human work at a glance, and the tools to verify it have historically been expensive, inaccurate, or locked behind enterprise contracts.
              </p>
              <p className="text-silver-600 text-base leading-relaxed">
                We are building multi-modal AI verification that is honest about its accuracy, transparent about its methodology, and free enough for a high-school teacher in a rural district to use it every day. If you can read this, you can use Aiscern.
              </p>
            </div>
          </div>
          ...
          <div className="bg-depth-bg border border-white/[0.06] rounded-xl p-8 text-center">
            <h2 className="text-2xl font-semibold text-silver-900 mb-3">Start verifying today</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/detect/text"
                ...
                Try Free Verification <ArrowRight className="w-4 h-4" aria-hidden="true" />
              </Link>
