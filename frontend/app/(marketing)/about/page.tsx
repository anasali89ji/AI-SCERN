...
export const metadata = {
  ...
  description: 'Aiscern is a free multi-modal AI content verification platform built in Pakistan. Analyze AI-generated text, images, audio, and video with ensemble-based analysis and published accuracy benchmarks.',
...
const TIMELINE = [
  ...
  { year: '2025', title: 'Multi-modal verification built', desc: 'Trained on a self-assembled dataset spanning text, image, audio, and video across dozens of AI generators.' },
