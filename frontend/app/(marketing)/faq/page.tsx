...
const FAQ_SECTIONS = [
  {
    title: 'Pricing & Plans',
    items: [
      { q: 'Is there really a free plan?',           a: 'Yes. The free tier includes 10 scans per day on text and deepfake image detection. No credit card required.',                           link: { label: 'See all pricing plans', href: '/pricing' } },
      { q: 'What happens if I hit my daily limit?',  a: 'You can wait for the next day or upgrade to Pro instantly. Your detection count resets every 24 hours.',                           link: null },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Does Aiscern work in languages other than English?', a: 'Text detection works best in English. We have partial support for Spanish, French, German, and Arabic. Image, audio, and deepfake video detection are language-agnostic.', link: null },
    ],
  },
  {
    title: 'Privacy & Security',
    items: [
      { q: 'Does Aiscern store my content?',         a: 'Files and text submitted for detection are processed and immediately deleted. We do not use your content to train models. Metadata (verdict, confidence score, timestamp) is stored per your plan\'s detection history setting.', link: { label: 'Read our Privacy Policy', href: '/privacy' } },
