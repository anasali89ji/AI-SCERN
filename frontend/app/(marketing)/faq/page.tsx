...
const FAQ_SECTIONS = [
  {
    title: 'Pricing & Plans',
    items: [
      { q: 'Is there really a free plan?',           a: 'Yes. The free tier includes 10 examinations per day on text and image verification. No credit card required.',                           link: { label: 'See all pricing plans', href: '/pricing' } },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What AI generators can you verify?',     a: 'Our models are updated quarterly. We verify content from major generators including ChatGPT, GPT-4, Claude, Midjourney, DALL-E, Stable Diffusion, ElevenLabs, and common TTS tools. Novel generators released after our last update may evade verification until the next fine-tune.', link: null },
      ...
      { q: 'Does Aiscern work in languages other than English?', a: 'Text verification works best in English. We have partial support for Spanish, French, German, and Arabic. Image, audio, and video verification are language-agnostic.', link: null },
    ],
  },
  {
    title: 'Privacy & Security',
    items: [
      { q: 'Does Aiscern store my content?',         a: 'Files and text submitted for verification are processed and immediately deleted. We do not use your content to train models. Metadata (verdict, integrity rating, timestamp) is stored per your plan\'s verification history setting.', link: { label: 'Read our Privacy Policy', href: '/privacy' } },
