...
const FAQ_SECTIONS = [
  {
    title: 'Pricing & Plans',
    items: [
      { q: 'Is there really a free plan?',           a: 'Yes. The free tier includes 10 scans per day on text and deepfake image verification. No credit card required.',                           link: { label: 'See all pricing plans', href: '/pricing' } },
      { q: 'What happens if I hit my daily limit?',  a: 'You can wait for the next day or upgrade to Pro instantly. Your verification count resets every 24 hours.',                           link: null },
      ...
      { q: 'Will the free tier stay?',               a: 'Yes. We believe everyone deserves access to basic AI verification. The free tier is permanent.',                                  link: null },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Can I use Aiscern for legal or academic decisions?', a: 'No. Verification results are probabilistic, not definitive. Always use human judgment for high-stakes decisions. Never use a single verification result as sole evidence in legal proceedings or academic integrity cases.', link: null },
      { q: 'What AI generators can you analyze?',     a: 'Our models are updated quarterly. We analyze content from major generators including ChatGPT, GPT-4, Claude, Midjourney, DALL-E, Stable Diffusion, ElevenLabs, and common TTS tools. Novel generators released after our last update may evade verification until the next fine-tune.', link: null },
      { q: 'How does the ensemble work?',            a: 'We run content through multiple independent forensic signals and combine them into a single confidence score. No single model makes the final call — results are cross-verified before delivering a verdict.',                                                                                        link: { label: 'Read the methodology', href: '/methodology' } },
      { q: 'Does Aiscern work in languages other than English?', a: 'Text verification works best in English. We have partial support for Spanish, French, German, and Arabic. Image, audio, and deepfake video verification are language-agnostic.', link: null },
    ],
  },
  {
    title: 'Privacy & Security',
    items: [
      { q: 'Does Aiscern store my content?',         a: 'Files and text submitted for verification are processed and immediately deleted. We do not use your content to train models. Metadata (verdict, confidence score, timestamp) is stored per your plan\'s verification history setting.', link: { label: 'Read our Privacy Policy', href: '/privacy' } },
