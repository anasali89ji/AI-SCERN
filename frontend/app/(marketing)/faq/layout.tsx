...
const FAQ_JSONLD = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'What AI generators can you verify?', acceptedAnswer: { '@type': 'Answer', text: 'Our models are updated quarterly. We verify content from major generators including ChatGPT, GPT-4, Claude, Midjourney, DALL-E, Stable Diffusion, ElevenLabs, and common TTS tools. Novel generators released after our last update may evade verification until the next fine-tune.' } },
