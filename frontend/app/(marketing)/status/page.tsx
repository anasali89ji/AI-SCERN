...
const SERVICES = [
  { name: 'AI Text Detection API',    status: 'operational', latency: '< 2s'   },
  { name: 'Deepfake Image Detection API',   status: 'operational', latency: '5–10s'  },
  { name: 'AI Audio & Voice Clone Detection API',   status: 'operational', latency: '8–15s'  },
  { name: 'Deepfake Video Detection API',   status: 'operational', latency: '30–90s' },
