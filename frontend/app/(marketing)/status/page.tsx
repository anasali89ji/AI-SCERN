      ...
      <main className="min-h-screen bg-[#08080d] pt-16">
        ...
        <section className="py-16 md:py-20">
          <div className="max-w-3xl 2xl:max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 2xl:px-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-slate-100 mb-4">System Status</h1>
        ...
        <section className="pb-16">
          <div className="max-w-3xl 2xl:max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 2xl:px-10">
            <h2 className="text-sm font-bold text-slate-500 uppercase tracking-widest mb-4">Services</h2>
            ...
            <div className="mt-6 grid sm:grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="card border border-white/[0.08] rounded-xl p-4 text-center">
                  <div className="text-2xl font-black text-slate-100 mb-1">{stat.value}</div>
            ...
            {/* Incident History */}
            <div className="mt-10">
              <h2 className="text-sm font-bold text-slate-500 uppercase tracking-widest mb-4">Recent Incidents</h2>
              {INCIDENTS.length === 0 ? (
                <div className="card border border-white/[0.08] rounded-xl p-6 text-center text-slate-500 text-sm flex items-center justify-center gap-2">
