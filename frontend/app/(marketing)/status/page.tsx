...
export const metadata: Metadata = {
  ...
  description: 'Current operational status for Aiscern AI verification services, API, and infrastructure.',
  openGraph: {
    title: 'System Status — Aiscern',
...
const SERVICES = [
  { name: 'AI Text Verification API',    status: 'operational', latency: '< 2s'   },
  { name: 'Deepfake Image Verification API',   status: 'operational', latency: '5–10s'  },
  { name: 'AI Audio & Voice Clone Verification API',   status: 'operational', latency: '8–15s'  },
  { name: 'Deepfake Video Verification API',   status: 'operational', latency: '30–90s' },
          ...
          <div className="max-w-3xl 2xl:max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 2xl:px-10 text-center">
            <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold mb-6 ${
              ...
              {allOperational ? (
                ...
                <><TriangleAlert className="w-4 h-4" /> Service Degradation Verified</>
              )}
            </div>
