...
const SERVICES = [
  { name: 'Text Verification API',    status: 'operational', latency: '< 2s'   },
  { name: 'Image Verification API',   status: 'operational', latency: '5–10s'  },
  { name: 'Audio Verification API',   status: 'operational', latency: '8–15s'  },
  { name: 'Video Verification API',   status: 'operational', latency: '30–90s' },
