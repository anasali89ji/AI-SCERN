        ...
        <section className="pt-10 pb-14 md:py-28 relative overflow-hidden">
          ...
          <div className="max-w-4xl 2xl:max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 text-center relative">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-5 leading-tight">
              Build on Aiscern.<br /><span className="text-[#2BEE34]">Grow Together.</span>
            </h1>
          ...
          <div className="max-w-5xl 2xl:max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12">
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {PARTNER_TYPES.map((pt, i) => {
                const PIcon = pt.icon
                return (
                  <div key={i} className="card border border-[#1E1E1E] rounded-xl p-6">
                    <div className="w-10 h-10 rounded-xl bg-[#2BEE34]/10 border border-[#2BEE34]/20 flex items-center justify-center mb-4">
                      <PIcon className="w-5 h-5 text-[#2BEE34]" />
                    </div>
                    <h3 className="font-bold text-white mb-2">{pt.title}</h3>
                    <p className="text-sm text-[#6B6B6B] mb-4 leading-relaxed">{pt.desc}</p>
                    <ul className="space-y-2">
                      {pt.benefits.map((b, j) => (
                        <li key={j} className="flex items-center gap-2 text-xs text-[#A3A3A3]">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center gap-10">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#2BEE34]/10 border border-[#2BEE34]/20 text-xs font-semibold text-[#2BEE34] mb-4">
              ...
              <div className="flex-shrink-0 w-full lg:w-auto">
                <pre className="bg-background border border-[#1E1E1E] rounded-xl p-4 text-xs text-[#A3A3A3] overflow-x-auto font-mono">
    ...
    "gemini": 0.85
        ...
        <section className="py-16 md:py-20">
          <div className="max-w-2xl 2xl:max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 text-center">
            ...
            <p className="text-[#A3A3A3] mb-6 text-sm">Tell us about your platform, use case, and expected volume. We&apos;ll respond within 2 business days.</p>
