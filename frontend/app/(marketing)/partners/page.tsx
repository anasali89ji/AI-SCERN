            ...
            <div className="flex flex-col lg:flex-row items-center gap-10">
              <div className="flex-1">
                ...
                <p className="text-silver-600 text-sm leading-relaxed mb-5">
                  Every verification capability is available via our documented REST API. Text, image, audio, and video verification endpoints with structured JSON responses. SDKs and code examples available in the docs.
                </p>
