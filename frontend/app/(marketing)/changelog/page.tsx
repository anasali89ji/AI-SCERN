...
const RELEASES: {
...
}[] = [
  {
    version: 'v4.1.0',
    date: 'April 2026',
    summary: 'Updated deepfake image verification model and audio accuracy improvements.',
    changes: [
      { type: 'improvement', text: 'Improved audio verification accuracy to ~79% on WaveFake benchmark' },
      ...
      { type: 'fix',         text: 'Fixed deepfake video verification timeout for clips longer than 2 minutes' },
  ...
  },
  {
    version: 'v4.0.0',
    date: 'March 2026',
    summary: 'Major ensemble rewrite. Verification signal logic overhauled across all modalities.',
    changes: [
      { type: 'new',         text: 'Complete rewrite of verification signal logic in hf-analyze.ts (v5.0.0)' },
      { type: 'improvement', text: 'Multi-model consensus now weights by modality — no single model dominates verdict' },
      { type: 'improvement', text: 'Text verification ensemble updated with DeBERTa-v3-base' },
      { type: 'new',         text: 'Audio verification added (ElevenLabs, common TTS tools, voice clones)' },
  ...
  },
  {
    version: 'v3.2.0',
    date: 'February 2026',
    summary: 'Bulk verification, API access, and verification history.',
    changes: [
      { type: 'new',         text: 'Bulk verification — process up to 20 files simultaneously' },
      { type: 'new',         text: 'REST API v1 endpoint for AI text verification (Team+)' },
      { type: 'new',         text: 'Verification history saved for signed-in users' },
  ...
  },
  {
    version: 'v3.0.0',
    date: 'January 2026',
    summary: 'Video verification added (experimental). ARIA verification assistant launched.',
    changes: [
      { type: 'new',         text: 'Video deepfake verification — experimental, ~76% accuracy' },
      { type: 'new',         text: 'ARIA — AI Verification Assistant chatbot' },
      { type: 'new',         text: 'Verification share links — shareable results with one click' },
      { type: 'improvement', text: 'Image verification improved with CLIP-based signal analysis' },
    ],
  },
  {
    version: 'v2.0.0',
    date: 'December 2025',
    summary: 'Initial public launch. Text and deepfake image verification live.',
    changes: [
      { type: 'new', text: 'Text verification (RoBERTa ensemble) — ~85% accuracy' },
      { type: 'new', text: 'Image verification (ViT + GAN artifacts) — ~82% accuracy' },
