...
const RELEASES: {
...
}[] = [
  {
    version: 'v4.1.0',
    date: 'April 2026',
    summary: 'Updated image attestation model and audio accuracy improvements.',
    changes: [
      { type: 'improvement', text: 'Improved audio attestation accuracy to ~79% on WaveFake benchmark' },
      ...
      { type: 'fix',         text: 'Fixed video attestation timeout for clips longer than 2 minutes' },
  ...
  },
  {
    version: 'v4.0.0',
    date: 'March 2026',
    summary: 'Major ensemble rewrite. Attestation signal logic overhauled across all modalities.',
    changes: [
      { type: 'new',         text: 'Complete rewrite of attestation signal logic in hf-analyze.ts (v5.0.0)' },
      { type: 'improvement', text: 'Multi-model consensus now weights by modality — no single model dominates verdict' },
      { type: 'improvement', text: 'Text attestation ensemble updated with DeBERTa-v3-base' },
      { type: 'new',         text: 'Audio attestation added (ElevenLabs, common TTS tools, voice clones)' },
  ...
  },
  {
    version: 'v3.2.0',
    date: 'February 2026',
    summary: 'Bulk attestation, API access, and attestation history.',
    changes: [
      { type: 'new',         text: 'Bulk attestation — process up to 20 files simultaneously' },
      { type: 'new',         text: 'REST API v1 endpoint for text attestation (Team+)' },
      { type: 'new',         text: 'Attestation history saved for signed-in users' },
  ...
  },
  {
    version: 'v3.0.0',
    date: 'January 2026',
    summary: 'Video attestation added (experimental). ARIA attestation assistant launched.',
    changes: [
      { type: 'new',         text: 'Video deepfake attestation — experimental, ~76% accuracy' },
      { type: 'new',         text: 'ARIA — AI Attestation Assistant chatbot' },
      { type: 'new',         text: 'Attestation share links — shareable results with one click' },
      { type: 'improvement', text: 'Image attestation improved with CLIP-based signal analysis' },
    ],
  },
  {
    version: 'v2.0.0',
    date: 'December 2025',
    summary: 'Initial public launch. Text and image attestation live.',
    changes: [
      { type: 'new', text: 'Text attestation (RoBERTa ensemble) — ~85% accuracy' },
      { type: 'new', text: 'Image attestation (ViT + GAN artifacts) — ~82% accuracy' },
