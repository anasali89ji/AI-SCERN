...
const RELEASES: {
...
}[] = [
  {
    version: 'v4.1.0',
    date: 'April 2026',
    summary: 'Updated image verification model and audio accuracy improvements.',
    changes: [
      ...
      { type: 'fix',         text: 'Fixed video verification timeout for clips longer than 2 minutes' },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: 'new',         text: 'REST API v1 endpoint for text verification (Team+)' },
  ...
  },
  {
    version: 'v2.0.0',
    date: 'December 2025',
    summary: 'Initial public launch. Text and image verification live.',
    changes: [
