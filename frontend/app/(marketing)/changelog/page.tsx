...
const RELEASES: {
...
}[] = [
  {
    version: 'v4.1.0',
    date: 'April 2026',
    summary: 'Updated deepfake image detection model and audio accuracy improvements.',
    changes: [
      ...
      { type: 'fix',         text: 'Fixed deepfake video detection timeout for clips longer than 2 minutes' },
  ...
  },
  {
    version: 'v3.2.0',
    date: 'February 2026',
    summary: 'Bulk detection, API access, and detection history.',
    changes: [
      { type: 'new',         text: 'Bulk detection — process up to 20 files simultaneously' },
      { type: 'new',         text: 'REST API v1 endpoint for AI text detection (Team+)' },
      { type: 'new',         text: 'Detection history saved for signed-in users' },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: 'new',         text: 'Detection share links — shareable results with one click' },
  ...
  },
  {
    version: 'v2.0.0',
    date: 'December 2025',
    summary: 'Initial public launch. Text and deepfake image detection live.',
    changes: [
