  ...
  return (
    <SolutionPage
      ...
      features={[
        ...
        { icon: <Shield className="w-5 h-5" />, title: 'Export & Evidence', desc: 'PDF forensic reports include detection ID, timestamp, model breakdown, and per-sentence scores for grade appeals.' },
      ...
      faqs={[
        ...
        { q: 'Does Aiscern store student submissions?', a: 'We follow a strict data minimization policy. Detection content is processed ephemerally and not stored beyond the session unless you explicitly save a report. See our /transparency page for full details.' },
