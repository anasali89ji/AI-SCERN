...
export const metadata: Metadata = {
  ...
  description: 'Attest AI-generated essays, assignments, and research papers. Purpose-built for teachers, professors, and academic institutions. Free tier available.',
  openGraph: {
    title: 'AI Attestation for Education — Aiscern',
    description: 'Protect academic integrity with ensemble-based AI text attestation. Built for educators and institutions.',
  ...
  return (
    <SolutionPage
      ...
      painPoints={[
        ...
        { title: 'Single-model attestation tools have high false-positive rates', desc: 'Tools that rely on one model flag innocent students. Aiscern uses an ensemble to reduce false positives below 3%.' },
        { title: 'Students are evading attestation with paraphrasing tools', desc: 'Light paraphrasing fools simpler attestation tools. Aiscern analyzes linguistic fingerprints that survive paraphrasing.' },
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'Ensemble Attestation', desc: 'Combines RoBERTa, Binoculars perplexity analysis, and Gemini for ≥96% ensemble AUC across student writing datasets.' },
        ...
        { icon: <Shield className="w-5 h-5" />, title: 'Export & Evidence', desc: 'PDF forensic reports include attestation ID, timestamp, model breakdown, and per-sentence scores for grade appeals.' },
        { icon: <Eye className="w-5 h-5" />, title: 'Multi-Language Support', desc: 'Attestation works across English, Spanish, French, German, and more — covering international student submissions.' },
      ]}
      useCases={[
      ...
      faqs={[
        ...
        { q: 'Can I integrate Aiscern with my LMS (Canvas, Moodle, Blackboard)?', a: 'API access is available on Pro and Team plans. You can call our attestation endpoint from any LMS that supports webhook integrations or custom plugins. Documentation is at /docs/api.' },
        { q: 'Does Aiscern store student submissions?', a: 'We follow a strict data minimization policy. Attestation content is processed ephemerally and not stored beyond the session unless you explicitly save a report. See our /transparency page for full details.' },
        { q: 'What languages are supported?', a: 'English attestation has the highest accuracy. We support Spanish, French, German, Portuguese, and several other European languages with slightly reduced accuracy. Non-Latin scripts are in development.' },
      ]}
