...
export const metadata: Metadata = {
  ...
  description: 'Verify AI-generated essays, assignments, and research papers. Purpose-built for teachers, professors, and academic institutions. Free tier available.',
  openGraph: {
    title: 'AI Verification for Education — Aiscern',
    description: 'Protect academic integrity with ensemble-based AI text verification. Built for educators and institutions.',
  ...
  return (
    <SolutionPage
      ...
      painPoints={[
        ...
        { title: 'Single-model verification tools have high false-positive rates', desc: 'Tools that rely on one model flag innocent students. Aiscern uses an ensemble to reduce false positives below 3%.' },
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'Ensemble Verification', desc: 'Combines RoBERTa, Binoculars perplexity analysis, and Gemini for ≥96% ensemble AUC across student writing datasets.' },
