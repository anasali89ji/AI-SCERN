...
export const metadata: Metadata = {
  title: 'AI Verification for Education — Aiscern',
  description: 'Analyze AI-generated essays, assignments, and research papers. Purpose-built for teachers, professors, and academic institutions. Free tier available.',
  openGraph: {
    title: 'AI Verification for Education — Aiscern',
    description: 'Protect academic integrity with ensemble-based AI AI text verification. Built for educators and institutions.',
...
export default function EducationPage() {
  return (
    <SolutionPage
      ...
      description="AI-generated essays are flooding classrooms. Aiscern gives educators a forensic-grade ensemble verification system to identify AI-written assignments across text modalities — with explainable results, not just scores."
      ...
      painPoints={[
        ...
        { title: 'Single-model verification tools have high false-positive rates', desc: 'Tools that rely on one model flag innocent students. Aiscern’s ensemble cuts the false-positive rate to 6% on text benchmarks — single models run 8–10%.' },
        { title: 'Students are evading verification with paraphrasing tools', desc: 'Light paraphrasing fools simpler verification tools. Aiscern analyzes linguistic fingerprints that survive paraphrasing.' },
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'Ensemble Verification', desc: 'Combines RoBERTa, Binoculars perplexity analysis, and Gemini for a 0.94 ensemble AUC across student writing datasets (see /benchmarks).' },
        ...
        { icon: <Shield className="w-5 h-5" />, title: 'Export & Evidence', desc: 'PDF forensic reports include verification ID, timestamp, model breakdown, and per-sentence scores for grade appeals.' },
        { icon: <Eye className="w-5 h-5" />, title: 'Multi-Language Support', desc: 'Verification works across English, Spanish, French, German, and more — covering international student submissions.' },
      ]}
      useCases={[
      ...
      faqs={[
        ...
        { q: 'Can I integrate Aiscern with my LMS (Canvas, Moodle, Blackboard)?', a: 'API access is available on Pro and Team plans. You can call our verification endpoint from any LMS that supports webhook integrations or custom plugins. Documentation is at /docs/api.' },
        { q: 'Does Aiscern store student submissions?', a: 'We follow a strict data minimization policy. Verification content is processed ephemerally and not stored beyond the session unless you explicitly save a report. See our /transparency page for full details.' },
        { q: 'What languages are supported?', a: 'English verification has the highest accuracy. We support Spanish, French, German, Portuguese, and several other European languages with slightly reduced accuracy. Non-Latin scripts are in development.' },
      ]}
