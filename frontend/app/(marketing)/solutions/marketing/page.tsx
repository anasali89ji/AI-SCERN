...
export const metadata: Metadata = {
  title: 'AI Verification for Marketing & Brand — Aiscern',
  description: 'Audit UGC, influencer deliverables, and agency content for AI generation. Protect your brand voice with ensemble-based verification.',
  openGraph: {
    title: 'AI Verification for Marketing — Aiscern',
...
export default function MarketingPage() {
  return (
    <SolutionPage
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'Text Content Verification', desc: 'Identify AI-generated blog posts, product descriptions, social captions, and UGC submissions with ≥96% ensemble AUC.' },
        { icon: <Eye className="w-5 h-5" />, title: 'Image Authenticity', desc: 'Verify AI-generated brand imagery, synthetic product photos, and fabricated lifestyle content.' },
      ...
      faqs={[
        { q: 'Can Aiscern verify AI content that has been edited by a human?', a: 'Human editing reduces AI confidence scores, particularly extensive editing. Lightly edited AI content typically scores 45–75%. Heavily edited content may fall below our 62% AI threshold. We report confidence ranges, not binary verdicts, to reflect this nuance.' },
        { q: 'How does verification work for short-form content like social captions?', a: 'Short texts (under 150 words) have wider confidence intervals because there is less linguistic signal to analyze. We recommend supplementing with longer form analysis when assessing short-form content.' },
        ...
        { q: 'Does Aiscern verify AI-generated product images from tools like Midjourney?', a: 'Yes. Our image ensemble is trained on output from Midjourney, DALL-E, Stable Diffusion, Ideogram, and other major generators. Benchmark accuracy for diffusion model imagery is ≥93% AUC on our test datasets.' },
