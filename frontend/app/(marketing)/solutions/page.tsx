...
const colorMap: Record<string, { bg: string; border: string; text: string; icon: string }> = {
  ...
  amber:   { bg: 'bg-amber-500/10', border: 'border-amber-500/25',   text: 'text-amber-400',   icon: 'text-amber-400'   },
  emerald: { bg: 'bg-emerald-500/10', border: 'border-emerald-500/25', text: 'text-emerald-400', icon: 'text-emerald-400' },
  rose:    { bg: 'bg-rose-500/10',  border: 'border-rose-500/25',    text: 'text-rose-400',    icon: 'text-rose-400'    },
}
