  ...
  return (
    <SolutionPage
      ...
      painPoints={[
        ...
        { title: 'Viral deepfake videos spread before verification can catch up', desc: 'The attestation window is narrow. By the time manual verification completes, synthetic content has already been widely shared.' },
      ]}
      features={[
      ...
      useCases={[
        ...
        { title: 'Source Audio Authentication', desc: 'An investigative journalist receives an audio clip purportedly of a government official. Aiscern\'s audio attestation pipeline analyzes spectral characteristics to flag potential voice cloning.' },
      ]}
      faqs={[
        { q: 'How fast can Aiscern analyze submitted content during breaking news?', a: 'Text attestation returns results in under 2 seconds for most submissions. Image and audio attestation complete within 5–15 seconds. Video analysis is longer — typically 30–90 seconds per minute of footage.' },
        { q: 'Does image attestation work on screenshots and compressed social media images?', a: 'Yes, though compression artifacts can reduce accuracy. We recommend submitting the highest-quality version available. Our pixel-integrity layer is designed to work on JPEG-compressed images.' },
        { q: 'What is the false positive rate for image attestation?', a: 'Our image ensemble achieves approximately 5% false positive rate on benchmark datasets. Real-world rates vary by image type. We always recommend human editorial review of flagged content.' },
        { q: 'Can Aiscern attest deepfake video of political figures?', a: 'Our video pipeline analyzes temporal consistency and facial artifacts. It performs best on face-swap and lip-sync deepfakes. Highly sophisticated full-body synthesis may reduce accuracy — see our /benchmarks page for dataset-specific results.' },
