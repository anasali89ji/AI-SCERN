  ...
  return (
    <SolutionPage
      ...
      features={[
        ...
        { icon: <FileSearch className="w-5 h-5" />, title: 'Forensic Reports', desc: 'Exportable reports with model confidence breakdown, detection ID, and timestamp for editorial documentation.' },
      ...
      useCases={[
        ...
        { title: 'Source Audio Authentication', desc: 'An investigative journalist receives an audio clip purportedly of a government official. Aiscern\'s AI audio & voice clone detection pipeline analyzes spectral characteristics to flag potential voice cloning.' },
      ]}
      faqs={[
        { q: 'How fast can Aiscern analyze submitted content during breaking news?', a: 'Text detection returns results in under 2 seconds for most submissions. Image and AI audio & voice clone detection complete within 5–15 seconds. Video analysis is longer — typically 30–90 seconds per minute of footage.' },
        ...
        { q: 'What is the false positive rate for deepfake image detection?', a: 'Our image ensemble achieves approximately 5% false positive rate on benchmark datasets. Real-world rates vary by image type. We always recommend human editorial review of flagged content.' },
