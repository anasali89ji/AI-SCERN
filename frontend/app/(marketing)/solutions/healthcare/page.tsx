  ...
  return (
    <SolutionPage
      ...
      faqs={[
        ...
        { q: 'Can Aiscern analyze AI-generated radiology reports?', a: 'Yes — radiology reports are text documents and are analyzed by our AI text detection ensemble. The formulaic nature of radiology reporting means some genuine reports may fall in our uncertain confidence zone.' },
