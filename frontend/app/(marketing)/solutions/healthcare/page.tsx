...
export const metadata: Metadata = {
  title: 'AI Verification for Healthcare — Aiscern',
...
export default function HealthcarePage() {
  return (
    <SolutionPage
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'Medical Literature Screening', desc: 'Analyze AI-generated sections in submitted research papers, systematic reviews, and clinical study reports.' },
        ...
        { icon: <Eye className="w-5 h-5" />, title: 'Medical Image Forensics', desc: 'ViT-based verification identifies digitally synthesized medical imagery for research and insurance fraud contexts.' },
      ...
      faqs={[
        ...
        { q: 'How accurate is verification on medical writing specifically?', a: 'Medical writing has distinct stylistic patterns. Our ensemble performs well on academic medical text. Clinical notes — which are typically terse and formulaic — may score in uncertain ranges even when genuine. We recommend using Aiscern as a screening layer, not a definitive judgment tool.' },
        { q: 'Can Aiscern analyze AI-generated radiology reports?', a: 'Yes — radiology reports are text documents and are analyzed by our AI text verification ensemble. The formulaic nature of radiology reporting means some genuine reports may fall in our uncertain confidence zone.' },
