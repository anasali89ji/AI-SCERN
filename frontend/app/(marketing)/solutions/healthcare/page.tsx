...
export default function HealthcarePage() {
  return (
    <SolutionPage
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'Medical Literature Screening', desc: 'Verify AI-generated sections in submitted research papers, systematic reviews, and clinical study reports.' },
      ...
      faqs={[
        ...
        { q: 'Can Aiscern verify AI-generated radiology reports?', a: 'Yes — radiology reports are text documents and are analyzed by our text verification ensemble. The formulaic nature of radiology reporting means some genuine reports may fall in our uncertain confidence zone.' },
