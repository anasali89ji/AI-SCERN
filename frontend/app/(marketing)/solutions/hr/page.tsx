...
export default function HRPage() {
  return (
    <SolutionPage
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'Ensemble AI Text Verification', desc: 'Multi-model analysis flags AI-generated cover letters, personal statements, and written assessments with high confidence.' },
      ...
      faqs={[
        ...
        { q: 'Can Aiscern analyze PDF resumes?', a: 'Yes. Our batch endpoint accepts PDF, DOCX, and plain text. Text is extracted and analyzed through the full verification results ensemble.' },
