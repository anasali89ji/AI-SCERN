...
export default function HRPage() {
  return (
    <SolutionPage
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'Ensemble AI Text Detection', desc: 'Multi-model analysis flags AI-generated cover letters, personal statements, and written assessments with high confidence.' },
        ...
        { icon: <CircleCheck className="w-5 h-5" />, title: 'Audit Trails', desc: 'Exportable PDF reports with detection timestamp and model breakdown — defensible records for HR documentation.' },
      ...
      faqs={[
        ...
        { q: 'Can Aiscern analyze PDF resumes?', a: 'Yes. Our batch endpoint accepts PDF, DOCX, and plain text. Text is extracted and analyzed through the full detection results ensemble.' },
