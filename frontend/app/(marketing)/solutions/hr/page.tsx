...
export const metadata: Metadata = {
  title: 'AI Verification for HR & Recruiting — Aiscern',
  ...
  openGraph: {
    title: 'AI Verification for HR & Recruiting — Aiscern',
    description: 'Verify authenticity of job applications and work samples with ensemble AI verification.',
...
export default function HRPage() {
  return (
    <SolutionPage
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'Ensemble Text Verification', desc: 'Multi-model analysis flags AI-generated cover letters, personal statements, and written assessments with high confidence.' },
        ...
        { icon: <CircleCheck className="w-5 h-5" />, title: 'Audit Trails', desc: 'Exportable PDF reports with verification timestamp and model breakdown — defensible records for HR documentation.' },
      ...
      faqs={[
        { q: 'Is it fair to reject candidates based on AI verification?', a: 'We recommend using Aiscern as a screening signal, not a final decision. High AI scores should prompt a follow-up conversation or an alternative assessment — not automatic rejection. The tool surfaces patterns; humans make decisions.' },
        { q: 'Can Aiscern analyze PDF resumes?', a: 'Yes. Our batch endpoint accepts PDF, DOCX, and plain text. Text is extracted and analyzed through the full verification ensemble.' },
        ...
        { q: 'Can we integrate with ATS platforms like Greenhouse or Lever?', a: 'API access is available on Pro and Team plans. You can integrate our verification endpoint with any ATS that supports custom webhooks or zapier-style automation.' },
      ]}
    />
  )
}
