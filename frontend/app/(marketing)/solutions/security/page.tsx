...
export const metadata: Metadata = {
  ...
  description: 'Attest deepfake audio in fraud calls, synthetic identity documents, and AI-crafted phishing content. Built for trust & safety and cybersecurity teams.',
  openGraph: {
    title: 'AI Attestation for Cybersecurity — Aiscern',
...
export default function SecurityPage() {
  return (
    <SolutionPage
      ...
      description="AI-powered fraud — voice clone scams, deepfake identity verification bypass, and AI-crafted spear-phishing — is the fastest-growing attack surface. Aiscern gives security teams multi-modal attestation to stop synthetic content at every ingestion point."
      ...
      useCases={[
        ...
        { title: 'KYC Identity Document Screening', desc: 'A fintech company screens user-submitted selfie videos and ID photos through Aiscern\'s image pipeline as part of its onboarding fraud attestation stack.' },
      ...
      faqs={[
        { q: 'What is the latency of real-time audio attestation?', a: 'Asynchronous audio attestation processes a 30-second clip in approximately 3–8 seconds. Real-time streaming attestation is on our roadmap. For call center integration, we recommend a post-call analysis pipeline initially.' },
        { q: 'Can Aiscern attest voice clones of specific individuals?', a: 'Our attestation is general-purpose — it identifies AI-synthesized speech characteristics rather than comparing against a specific person\'s voiceprint. Speaker verification (matching a claimed identity) requires a separate biometric system.' },
        ...
        { q: 'How does Aiscern handle evasion attempts?', a: 'We continuously update our ensemble models against known evasion techniques. Our text attestation includes homoglyph and encoding attack attestation. Adversarial robustness is an ongoing research priority.' },
