...
export default function SecurityPage() {
  return (
    <SolutionPage
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'AI AI Text Detection', desc: 'Identify AI-generated phishing, social engineering, and synthetic content in ingested text streams.' },
        ...
        { icon: <TriangleAlert className="w-5 h-5" />, title: 'AI Voice Clone Detection', desc: 'wav2vec2 spectral analysis flags AI-synthesized speech against ASVspoof benchmark datasets.' },
        { icon: <Lock className="w-5 h-5" />, title: 'API Integration', desc: 'High-throughput REST API designed for security platform integration. Sub-2-second AI text detection for real-time screening.' },
        ...
        { icon: <BarChart3 className="w-5 h-5" />, title: 'SIEM-Ready Reporting', desc: 'Detection results include structured JSON output compatible with SIEM ingestion and SOC dashboards.' },
      ]}
      useCases={[
      ...
      faqs={[
        { q: 'What is the latency of real-time AI audio & voice clone detection?', a: 'Asynchronous AI audio & voice clone detection processes a 30-second clip in approximately 3–8 seconds. Real-time streaming detection is on our roadmap. For call center integration, we recommend a post-call analysis pipeline initially.' },
        { q: 'Can Aiscern analyze voice clones of specific individuals?', a: 'Our detection is general-purpose — it identifies AI-synthesized speech characteristics rather than comparing against a specific person\'s voiceprint. Speaker verification (matching a claimed identity) requires a separate biometric system.' },
        ...
        { q: 'How does Aiscern handle evasion attempts?', a: 'We continuously update our ensemble models against known evasion techniques. Our AI text detection includes homoglyph and encoding attack detection. Adversarial robustness is an ongoing research priority.' },
