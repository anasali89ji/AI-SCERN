  ...
  return (
    <SolutionPage
      ...
      faqs={[
        ...
        { q: 'Can Aiscern analyze AI text in legal documents with heavy boilerplate?', a: 'Legal documents contain significant boilerplate that may appear in AI training data. Our ensemble is tuned to distinguish genuine AI generation from standard legal language. Confidence scores below 62% indicate ambiguous sections.' },
