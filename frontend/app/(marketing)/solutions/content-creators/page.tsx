...
export default function ContentCreatorsPage() {
  return (
    <SolutionPage
      ...
      painPoints={[
        { title: 'Your genuine work is being flagged as AI-generated', desc: 'Overly aggressive AI detection tools flag human writers with distinctive styles, complex vocabulary, or non-native English as "AI." Aiscern\'s ensemble reduces these false positives.' },
      ...
      features={[
        ...
        { icon: <BarChart3 className="w-5 h-5" />, title: 'Historical Detection Records', desc: 'Signed-in users can access detection history — a record of your authenticated work over time.' },
      ]}
      useCases={[
        ...
        { title: 'Commissioned Art Authentication', desc: 'A game developer verifying commissioned character artwork scans submissions through Aiscern\'s deepfake image detection to confirm AI tools were not used in violation of their creative brief.' },
      ]}
      faqs={[
        ...
        { q: 'Can I share my Aiscern detection report as proof of authenticity?', a: 'Yes. Pro and higher tier users can export timestamped PDF reports with detection IDs. These can be shared with platforms, sponsors, or audiences as technical documentation of human authorship verification.' },
