  ...
  return (
    <SolutionPage
      ...
      useCases={[
        ...
        { title: 'Commissioned Art Authentication', desc: 'A game developer verifying commissioned character artwork scans submissions through Aiscern\'s image verification to confirm AI tools were not used in violation of their creative brief.' },
      ]}
      faqs={[
