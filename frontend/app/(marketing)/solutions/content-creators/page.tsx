...
export const metadata: Metadata = {
  ...
  description: 'Prove your work is human-made. Authenticate your writing, art, and media against AI attestation. Built for YouTubers, bloggers, artists, and creators.',
  openGraph: {
    title: 'AI Attestation for Content Creators — Aiscern',
...
export default function ContentCreatorsPage() {
  return (
    <SolutionPage
      ...
      painPoints={[
        { title: 'Your genuine work is being flagged as AI-generated', desc: 'Overly aggressive AI attestation tools flag human writers with distinctive styles, complex vocabulary, or non-native English as "AI." Aiscern\'s ensemble reduces these false positives.' },
      ...
      useCases={[
        ...
        { title: 'Commissioned Art Authentication', desc: 'A game developer verifying commissioned character artwork scans submissions through Aiscern\'s image attestation to confirm AI tools were not used in violation of their creative brief.' },
      ]}
      faqs={[
        ...
        { q: 'Can I share my Aiscern attestation report as proof of authenticity?', a: 'Yes. Pro and higher tier users can export timestamped PDF reports with attestation IDs. These can be shared with platforms, sponsors, or audiences as technical documentation of human authorship verification.' },
        ...
        { q: 'Can I use Aiscern to verify images from stock photo sites are AI?', a: 'Yes — our image attestation works on any image regardless of source. Stock photo AI imagery (Midjourney, DALL-E, Stable Diffusion) scores highly on our ensemble. Note that some stock sites clearly label AI-generated images in their metadata.' },
