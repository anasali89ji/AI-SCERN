...
export const metadata: Metadata = {
  ...
  description: 'Validate authenticity of research papers, datasets, and experiment logs. Maintain scientific integrity with ensemble AI attestation and API access.',
  openGraph: {
    title: 'AI Attestation for Academic Research — Aiscern',
  ...
  return (
    <SolutionPage
      ...
      painPoints={[
        ...
        { title: 'Peer review overload enabling AI submission proliferation', desc: 'Overwhelmed reviewers cannot manually attest AI-generated papers. Automated pre-screening is now a practical necessity for high-volume journals.' },
      ...
      features={[
        { icon: <Brain className="w-5 h-5" />, title: 'Research Paper Analysis', desc: 'Full-document ensemble attestation on academic papers with ≥96% AUC. Section-level confidence breakdown for targeted review.' },
      ...
      faqs={[
        ...
        { q: 'Can Aiscern attest AI use in only parts of a paper?', a: 'Yes — our sentence-level analysis highlights individual paragraphs and sentences that score above the AI threshold. This is particularly useful for papers where AI was used to generate introductions or discussion sections while methods and results are genuine.' },
        { q: 'Does attestation work on preprints and arXiv-style papers?', a: 'Yes. Aiscern analyzes the text content of papers regardless of their publication status. PDF upload is supported — text is extracted and analyzed through the full ensemble.' },
