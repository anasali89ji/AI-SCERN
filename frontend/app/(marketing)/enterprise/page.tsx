...
const FEATURES = [
  { icon: Zap, title: 'Custom API Rate Limits', desc: 'No shared infrastructure bottlenecks. Dedicated throughput aligned to your verification volume requirements.' },
  ...
  { icon: Layers, title: 'Batch Processing at Scale', desc: 'Bulk verify thousands of documents simultaneously via async batch API with webhook callbacks.' },
        ...
        <section className="pt-10 pb-14 md:py-28 relative overflow-hidden">
          ...
          <div className="max-w-4xl 2xl:max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 text-center relative">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-5 leading-tight">
              AI Verification at<br /><span className="text-accent">Enterprise Scale</span>
            </h1>
