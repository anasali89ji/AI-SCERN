...
function FeaturedCard({ post }: { post: BlogPostMeta }) {
  return (
    <Link href={`/blog/${post.slug}`}
      className="group block mb-6 rounded-xl border border-white/[0.08] bg-surface hover:border-primary/30 transition-all overflow-hidden">
...
function PostCard({ post }: { post: BlogPostMeta }) {
  return (
    <Link href={`/blog/${post.slug}`}
      className="group block rounded-xl border border-white/[0.08] bg-surface hover:border-primary/30 transition-all overflow-hidden">
