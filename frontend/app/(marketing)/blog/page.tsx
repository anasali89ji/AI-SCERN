...
export const metadata = {
  title: 'Aiscern Blog — AI Verification Insights',
  description: 'Learn how to analyze AI-generated content, understand deepfakes, and stay ahead of synthetic media with Aiscern.',
  openGraph: { title: 'Aiscern Blog', description: 'AI verification insights and guides', url: 'https://aiscern.com/blog' },
}
