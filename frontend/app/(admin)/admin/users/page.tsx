...
function StatusBadge({ user }: { user: User }) {
  if (user.is_banned)         return <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-rose-500/10 text-rose-400 border border-rose-500/20">Banned</span>
  if (!user.dashboard_access) return <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-amber-500/10 text-amber-400 border border-amber-500/20">Revoked</span>
...
function RequestStatusBadge({ status }: { status: string }) {
  if (status === 'pending')  return <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-amber-500/10 text-amber-400 border border-amber-500/20"><Clock className="w-2.5 h-2.5" />Pending</span>
  ...
  return <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-rose-500/10 text-rose-400 border border-rose-500/20"><XCircle className="w-2.5 h-2.5" />Rejected</span>
}
                        ...
                        <div className="flex items-center gap-1 flex-wrap">
                            ...
                            <>
                              {u.plan_granted_by && (
                                <button
                                  ...
                                  className="flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-semibold bg-rose-500/10 text-rose-400 border border-rose-500/20 hover:bg-rose-500/20 transition-colors"
                                >
                          ...
                          {u.dashboard_access ? (
                            <button
                              ...
                              className="flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-semibold bg-amber-500/10 text-amber-400 border border-amber-500/20 hover:bg-amber-500/20 transition-colors"
                            >
              ...
              {['pending', 'approved', 'rejected', 'all'].map(s => (
                ...
                >
                  ...
                  {s === 'pending' && pendingCount > 0 && (
                    <span className="ml-0.5 px-1.5 py-0.5 rounded bg-amber-500/20 text-amber-400 text-[9px] font-black">{pendingCount}</span>
                  )}
                </button>
              ))}
            </div>
                        ...
                        {r.status === 'pending' ? (
                          <div className="flex items-center gap-1.5">
                            ...
                            <button
                              ...
                              className="flex items-center gap-1 px-2.5 py-1.5 rounded-md text-[10px] font-bold bg-rose-500/10 text-rose-400 border border-rose-500/20 hover:bg-rose-500/20 transition-colors"
                            >
