    ...
    <RoleGuard required="EXECUTIVE">
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="rounded-xl border border-white/[0.08] bg-surface/60 p-8 max-w-sm w-full text-center">
          <div className="w-14 h-14 rounded-xl bg-[#FFB800]/10 border border-[#FFB800]/20 flex items-center justify-center mx-auto mb-4">
            <DollarSign className="w-7 h-7 text-[#FFB800]" />
          </div>
    ...
    <RoleGuard required="EXECUTIVE">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-[#FFB800] bg-[#FFB800]/10 border border-[#FFB800]/20 px-3 py-1 rounded-full font-medium">🔒 Restricted</span>
        </div>

        {/* Investor metrics */}
        <div className="rounded-xl border border-[#FFB800]/20 bg-[#FFB800]/5 p-5">
