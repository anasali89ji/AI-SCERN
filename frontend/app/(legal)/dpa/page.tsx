        ...
        <div className="prose-aiscern space-y-8">
          ...
          <Section title="1. Parties and Scope">
            ...
            <p>
              ...
              governs the processing of personal data that the Data Controller submits to Aiscern for AI content verification.
            </p>
          ...
          <Section title="3. Processing Details">
            <SubSection title="3.1 Subject Matter">
              <p>Aiscern processes personal data contained in content submitted for AI verification analysis (text documents, images, audio, video).</p>
            </SubSection>
            ...
            <SubSection title="3.3 Nature and Purpose">
              <p>Processing is performed solely to provide AI content verification results to the Data Controller. No secondary processing for Aiscern&apos;s own purposes occurs without explicit consent.</p>
            </SubSection>
            <SubSection title="3.4 Types of Personal Data">
              <ul>
                ...
                <li>Usage metadata (timestamps, verification counts, IP addresses)</li>
              </ul>
            </SubSection>
          ...
          <Section title="4. Processor Obligations">
            ...
            <ul>
              <li>Process Personal Data only on documented instructions from the Data Controller (i.e., providing verification results)</li>
          ...
          <Section title="5. Sub-processors (Annex A)">
            ...
            {(() => {
              const SUBPROCESSORS: [string, string, string, string][] = [
                ...
                ['Google Gemini API',             'AI inference (text/deepfake image verification)', 'US (Google)',   'SCC'],
