        ...
        <div className="prose-aiscern space-y-8">
          ...
          <Section title="2. Conformance Status">
            ...
            <div className="mt-4 space-y-3">
              ...
              <StatusItem icon="warn" label="Complex Widgets" detail="The detection result confidence visualisations and animated charts may not convey all information to screen reader users. Text alternatives are being added." />
          ...
          <Section title="4. Known Limitations">
            ...
            <ul>
              ...
              <li><strong>Real-time detection progress:</strong> Live detection updates use aria-live regions but may announce too frequently. We are reviewing announcement frequency.</li>
