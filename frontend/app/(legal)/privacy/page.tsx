        ...
        <div className="prose-aiscern space-y-8">
          ...
          <Section title="5. Data Sharing & Third Parties">
            ...
            <ul>
              ...
              <li><strong>Hugging Face (huggingface.co):</strong> AI model inference for text and audio verification. Inference API requests are not used to train Hugging Face models. <a href="https://huggingface.co/privacy" className="text-[#2BEE34] hover:underline">Hugging Face Privacy Policy</a></li>
              <li><strong>Google Gemini API (ai.google.dev):</strong> Gemini 2.0 Flash is used as an ensemble head for text and image verification. Google does not use Gemini API inputs to train its models. <a href="https://ai.google.dev/terms" className="text-[#2BEE34] hover:underline">Google AI Terms</a></li>
