...
export const metadata: Metadata = {
  title: 'Privacy Policy | Aiscern AI Verification',
        ...
        <div className="prose-aiscern space-y-8">
          <Section title="1. Introduction">
            <p>
              ...
              use, disclose, and safeguard your information when you use our AI content verification platform at{' '}
          ...
          <Section title="2. Information We Collect">
            <SubSection title="2.1 Information You Provide">
              <ul>
                ...
                <li><strong>Content you submit:</strong> Text, images, audio, or video files you upload for verification analysis</li>
            ...
            <SubSection title="2.2 Automatically Collected Data">
              <ul>
                <li><strong>Usage data:</strong> Pages visited, features used, verification history, timestamps</li>
          ...
          <Section title="3. How We Use Your Information">
            <ul>
              <li>Providing and improving the Aiscern verification service</li>
              <li>Processing your submitted content through AI models to generate verification results</li>
              <li>Maintaining your account and authentication</li>
              <li>Storing your verification history for your reference</li>
              <li>Improving our AI models and verification accuracy using anonymized, aggregated data</li>
              <li>Responding to support requests</li>
              <li>Sending service-related notifications (no marketing without consent)</li>
              <li>Verifying and preventing fraud, abuse, or security threats</li>
            </ul>
          </Section>

          <Section title="4. Content You Submit">
            <p>
              Files you upload for analysis are processed by our AI models and results are returned to you. We store verification
              results in your verification history. Uploaded files may be temporarily cached for processing purposes and are not
          ...
          <Section title="5. Data Sharing & Third Parties">
            ...
            <ul>
              ...
              <li><strong>Hugging Face (huggingface.co):</strong> AI model inference for text and AI audio & voice clone verification. Inference API requests are not used to train Hugging Face models. <a href="https://huggingface.co/privacy" className="text-[#2BEE34] hover:underline">Hugging Face Privacy Policy</a></li>
              <li><strong>Google Gemini API (ai.google.dev):</strong> Gemini 2.0 Flash is used as an ensemble head for text and deepfake image verification. Google does not use Gemini API inputs to train its models. <a href="https://ai.google.dev/terms" className="text-[#2BEE34] hover:underline">Google AI Terms</a></li>
          ...
          <Section title="6. Data Retention">
            <ul>
              ...
              <li><strong>Verification history:</strong> Retained for 12 months, then automatically deleted</li>
          ...
          <Section title="7. Shareable Result Links">
            <p>
              Aiscern allows you to generate a shareable link for any verification result. These links remain active for
              <strong> 30 days</strong> from the time of creation, after which they expire automatically.
            </p>
            <p>
              Shareable links contain only the verification verdict, confidence score, and associated metadata (modality, timestamp,
          ...
          <Section title="11. Your Rights">
            ...
            <ul>
              ...
              <li><strong>Portability:</strong> Export your verification history in JSON format</li>
          ...
          <Section title="13. GDPR & CCPA Rights">
            <SubSection title="EU/EEA Users (GDPR)">
              ...
              <p>Legal basis for processing: contract performance (verification results), legitimate interest (fraud prevention), and consent (analytics cookies).</p>
