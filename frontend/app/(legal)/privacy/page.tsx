...
export const metadata: Metadata = {
  title: 'Privacy Policy | Aiscern AI Detection',
        ...
        <div className="prose-aiscern space-y-8">
          ...
          <Section title="3. How We Use Your Information">
            <ul>
              ...
              <li>Storing your detection history for your reference</li>
          ...
          <Section title="4. Content You Submit">
            <p>
              ...
              results in your detection history. Uploaded files may be temporarily cached for processing purposes and are not
          ...
          <Section title="5. Data Sharing & Third Parties">
            ...
            <ul>
              ...
              <li><strong>Hugging Face (huggingface.co):</strong> AI model inference for text and AI audio & voice clone detection. Inference API requests are not used to train Hugging Face models. <a href="https://huggingface.co/privacy" className="text-[#2BEE34] hover:underline">Hugging Face Privacy Policy</a></li>
              <li><strong>Google Gemini API (ai.google.dev):</strong> Gemini 2.0 Flash is used as an ensemble head for text and deepfake image detection. Google does not use Gemini API inputs to train its models. <a href="https://ai.google.dev/terms" className="text-[#2BEE34] hover:underline">Google AI Terms</a></li>
          ...
          <Section title="6. Data Retention">
            <ul>
              ...
              <li><strong>Detection history:</strong> Retained for 12 months, then automatically deleted</li>
          ...
          <Section title="11. Your Rights">
            ...
            <ul>
              ...
              <li><strong>Portability:</strong> Export your detection history in JSON format</li>
          ...
          <Section title="13. GDPR & CCPA Rights">
            <SubSection title="EU/EEA Users (GDPR)">
              ...
              <p>Legal basis for processing: contract performance (detection results), legitimate interest (fraud prevention), and consent (analytics cookies).</p>
