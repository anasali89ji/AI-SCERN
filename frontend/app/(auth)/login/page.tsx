...
/* ── Isolated inner component that uses useSearchParams ─────────────────── */
/* Wrapped in its own Suspense so it doesn't cause BAILOUT_TO_CLIENT_SIDE_RENDERING */
function LoginInner() {
...
/* ── Static shell — renders server-side immediately ─────────────────────── */
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#06090f] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Card shell — static, always visible */}
      <div className="relative z-10 w-full max-w-[400px]">

        {/* Header — fully static SSR */}
        <div className="bg-[#0a0f1e] border border-white/8 border-b-0 rounded-t-2xl px-7 pt-6 pb-5">
          ...
          <p className="text-slate-400 text-[13px] mt-1">Sign in to your Aiscern account</p>
        </div>

        {/* Clerk widget — isolated in Suspense to prevent SSR bailout */}
