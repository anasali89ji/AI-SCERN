    ...
    <div className="min-h-screen bg-[#050510] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-[0.025]"
          style={{ backgroundImage: 'linear-gradient(rgba(37,99,235,0.2) 1px, transparent 1px), linear-gradient(90deg, rgba(37,99,235,0.2) 1px, transparent 1px)', backgroundSize: '60px 60px' }} />
      </div>
      ...
      <Link href="/" className="flex items-center gap-2.5 mb-7 relative z-10 group">
        ...
        <span className="text-xl font-semibold gradient-text tracking-tight">Aiscern</span>
      </Link>
      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        <SignIn
          ...
          appearance={{
            ...
            variables: {
              colorPrimary: '#2563eb', colorBackground: '#0c0c20',
            ...
            elements: {
              ...
              formFieldInput: 'w-full bg-[#080818] border-2 border-[#2f2f58] text-[#f1f5ff] placeholder:text-slate-600 rounded-[10px] text-[14px] px-3.5 py-2.5 transition-all duration-150 focus:outline-none focus:border-blue-500 focus:bg-[#0a0a22] focus:shadow-[0_0_0_4px_rgba(37,99,235,0.15)] hover:border-[#3d3d6e]',
              ...
              otpCodeFieldInput: 'bg-[#080818] border-2 border-[#2f2f58] text-white font-mono text-[20px] font-bold rounded-[10px] text-center w-11 h-12 focus:outline-none focus:border-blue-500 focus:shadow-[0_0_0_4px_rgba(37,99,235,0.15)] transition-all duration-150',
