...
const CLERK_APPEARANCE = {
  ...
  elements: {
    ...
    formFieldCheckboxInput: 'accent-blue-600 w-4 h-4 rounded border border-white/15',
...
function SignUpContent() {
  ...
  return (
    <div className="min-h-screen bg-[#06090f] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <p className="mt-4 text-[11px] text-slate-700 relative z-10 text-center max-w-xs">
        By signing up you agree to our{' '}
        <Link href="/terms" className="underline underline-offset-2 hover:text-slate-500 transition-colors">Terms</Link>{' '}
        and{' '}
        <Link href="/privacy" className="underline underline-offset-2 hover:text-slate-500 transition-colors">Privacy Policy</Link>.
      </p>
