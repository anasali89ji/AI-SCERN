    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 bg-surface-deep flex flex-col items-center justify-center px-4 py-10 lg:py-0">
        <div className="w-full max-w-[420px]">
          {/* Custom header */}
          <div className="bg-surface-deep border border-white/20 border-b-0 rounded-t-xl px-7 pt-7 pb-5">
          ...
          <SignUp
            ...
            appearance={{
              ...
              elements: {
                rootBox:                   'w-full',
                card:                      'bg-surface-deep border border-white/20 border-t-0 shadow-lift rounded-b-xl overflow-hidden p-0',
                header:                    '!hidden',
                main:                      'px-7 pb-2 pt-6',
